...
## Project Overview
This repository showcases QA/SDET work on a sample **Human Resource Management System (HRMS)** application. It is a portfolio project built with dummy/sample data only — no real client names, production data, or confidential information are included.
...
Selenium, Java, TestNG, Maven, Git, JIRA
